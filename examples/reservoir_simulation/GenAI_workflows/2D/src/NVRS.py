...
def Plot_RSM_Numerical(pertoutt, True_mat, Namesz):
    ...
    plt.plot(
        ...
        color=colors[0],
        lw="2",
        label="Left-preconditioned GMRES",
    )
    plt.plot(
        timezz,
        True_mat[1][:, 1],
    ...
    plt.plot(
        ...
        color=colors[2],
        lw="2",
        label="Left-preconditioned conjugate gradient",
    )
    plt.plot(
        timezz,
        True_mat[3][:, 1],
    ...
    plt.suptitle(
        "COMPARISON BETWEEN THE PINO SOLVER AND 6 NUMERICAL SOLVERS", fontsize=16
    )
    # os.chdir('RESULTS')
    plt.savefig(
        Namesz
...
def Plot_performance_Numerical(
    ...
    plt.subplot(4, 4, 1)
    plt.pcolormesh(XX.T, YY.T, (trueF[0][0, itt, :, :]) * pini_alt, cmap="jet")
    plt.title("Pressure GMRES", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 2)
    plt.pcolormesh(XX.T, YY.T, (trueF[1][0, itt, :, :]) * pini_alt, cmap="jet")
    plt.title("Pressure SPSOLVE", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 3)
    plt.pcolormesh(XX.T, YY.T, (trueF[2][0, itt, :, :]) * pini_alt, cmap="jet")
    plt.title("Pressure CONJUGATE GRADIENT", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 4)
    plt.pcolormesh(XX.T, YY.T, (trueF[3][0, itt, :, :]) * pini_alt, cmap="jet")
    plt.title("Pressure LSQR", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 5)
    plt.pcolormesh(XX.T, YY.T, (trueF[4][0, itt, :, :]) * pini_alt, cmap="jet")
    plt.title("Pressure CPR", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 6)
    plt.pcolormesh(XX.T, YY.T, trueF[0][0, itt + steppi, :, :], cmap="jet")
    plt.title("water_sat GMRES", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 7)
    plt.pcolormesh(XX.T, YY.T, trueF[1][0, itt + steppi, :, :], cmap="jet")
    plt.title("water_sat SPSOLVE", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 8)
    plt.pcolormesh(XX.T, YY.T, trueF[2][0, itt + steppi, :, :], cmap="jet")
    plt.title("water_sat CONJUGATE GRADIENT", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 9)
    plt.pcolormesh(XX.T, YY.T, trueF[3][0, itt + steppi, :, :], cmap="jet")
    plt.title("water_sat LSQR", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 10)
    plt.pcolormesh(XX.T, YY.T, trueF[4][0, itt + steppi, :, :], cmap="jet")
    plt.title("water_sat CPR", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 11)
    plt.pcolormesh(XX.T, YY.T, 1 - trueF[0][0, itt + steppi, :, :], cmap="jet")
    plt.title("oil_sat GMRES", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 12)
    plt.pcolormesh(XX.T, YY.T, 1 - trueF[1][0, itt + steppi, :, :], cmap="jet")
    plt.title("oil_sat SPSOLVE", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 13)
    plt.pcolormesh(XX.T, YY.T, 1 - trueF[2][0, itt + steppi, :, :], cmap="jet")
    plt.title("oil_sat CONJUGATE GRADIENT", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 14)
    plt.pcolormesh(XX.T, YY.T, 1 - trueF[3][0, itt + steppi, :, :], cmap="jet")
    plt.title("oil_sat LSQR", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
    ...
    plt.subplot(4, 4, 15)
    plt.pcolormesh(XX.T, YY.T, 1 - trueF[4][0, itt + steppi, :, :], cmap="jet")
    plt.title("oil_sat CPR", fontsize=13)
    plt.ylabel("Y", fontsize=13)
    plt.xlabel("X", fontsize=13)
    plt.axis([0, (nx - 1), 0, (ny - 1)])
    plt.gca().set_xticks([])
